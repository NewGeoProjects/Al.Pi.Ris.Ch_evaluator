...
processa_rischio <- function(df_input) {
  df_risultati <- data.frame(Nome_Sostanza = df_input$Nome_Sostanza, 
                             ...
                             IRc = NA,
                             IR_cumulativo = NA,
                             percentuale_durata = 35,
                             quantita_giornaliera_inalatoria = 0.5,
                             stato_fisico_inalatoria = "solido",
                             volatilita_inalatoria = "media",
                             tipo_processo_inalatoria = "energia meccanica",
                             protezione_tecnica_inalatoria = "ventilazione generale",
                             quantita_giornaliera_cutanea = 1,
                             modalita_contatto_cutanea = "manipolazione oggetti contaminati",
